...
(function (ext) {
    ...
    var descriptor = {
        blocks: [
          ...
          [' ', 'Say %s ', 'postToChat', 'ハロー、ワールド！' ],
          [' ', 'Place %s to X:%n Y:%n Z:%n ', 'setBlock', ' ',0,0,0 ],
          ['r', '%s Block Name', 'getBlockName', ' '],
          ['r', '%m.commonBlock', 'getCommonBlockID', 'Stone'],
          ['r', '%m.rareBlock', 'getRareBlockID', 'Gold'],
          ['r', '%m.colorfulWool', 'getColorfulWoolID', 'Wool White'],
          ['r', '%m.colorfulGlass', 'getColorfulGlassID', 'Glass White'],
          ['r', '%m.miscBlock', 'getMiscBlockID', 'Lava'],
          ['r', '%m.plantBlock', 'getPlantBlockID', 'Pampkin'],
          [' ', 'Reset Arround', 'worldReset'],
          [' ', 'Teleport X:%n Y:%n Z:%n ', 'setPlayer', 0,0,0 ],
          ['w', 'Get Player Position', 'getPlayerPos'],
          ['r', '%m.pos of Player Pos', 'playerXYZ', 'x'],
    ...
    ScratchExtensions.register('MicratchEng', descriptor, ext);
