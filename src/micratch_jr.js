...
(function (ext) {
    ...
    var descriptor = {
        ...
        menus: {
            pos: ['x', 'y', 'z'],
            blockPos: ['abs', 'rel'],
            commonBlock: ['石','草','土','丸石','オークのもくざい','マツのもくざい','シラカバのもくざい','ジャングルのもくざい','アカシアのもくざい','ダークオークのもくざい','砂','砂利','オークのげんぼく','マツのげんぼく','シラカバのげんぼく','ジャングルのげんぼく','レンガ','石レンガ','アカシアのげんぼく','ダークオークのげんぼく',],
            rareBlock: ['金ブロック','鉄ブロック','石炭ブロック','ダイヤブロック','エメラルドブロック','ラピスラズリブロック','ネザーラック','ソウルサンド','プリズマリン','プリズマリンレンガ','エンドストーン','プルパーブロック',],
            colorfulWool: ['白色のウール','オレンジのウール','マゼンダのウール','空色のウール','黄色のウール','黄緑色のウール','ピンクのウール','灰色のウール','薄灰色のウール','シアンのウール','紫色のウール','青色のウール','茶色のウール','緑色のウール','赤色のウール','黒色のウール',],
            colorfulGlass: ['白色の色付きガラス','オレンジの色付きガラス','マゼンダの色付きガラス','空色の色付きガラス','黄色の色付きガラス','黄緑色の色付きガラス','ピンクの色付きガラス','灰色の色付きガラス','薄灰色の色付きガラス','シアンの色付きガラス','紫色の色付きガラス','青色の色付きガラス','茶色の色付きガラス','緑色の色付きガラス','赤色の色付きガラス','黒色の色付きガラス',],
            miscBlock: ['空気','がんばん','水','ようがん','スポンジ','TNT','本だな','たいまつ','炎','チェスト','かまど','オークのドア(上)','オークのドア(下)','氷ブロック','雪ブロック','フェンス','グロウストーン','ジャック・オ・ランタン','鉄ごうし','ネザーレンガのフェンス','ビーコン','スライムブロック','シーランタン',],
