...
(function (ext) {
    ...
    var descriptor = {
        ...
        menus: {
            ...
            miscBlock: ['溶岩','水','オークのドア(上)','オークのドア(下)','空気','TNT','岩盤','レッドストーンブロック','グロウストーン','氷ブロック','シーランタン','ジャック・オ・ランタン','フェンス','鉄格子','本棚','雪ブロック','松明','かまど','木の感圧版','スポンジ','スライムブロック','チェスト','ビーコン','レッドストーンランプ(オフ)','レッドストーンランプ(オン)',],
