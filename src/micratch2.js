...
(function (ext) {
    ...
    var descriptor = {
        ...
        menus: {
            pos: ['x', 'y', 'z'],
            blockPos: ['abs', 'rel'],
            commonBlock: ['石','丸石','花崗岩','閃緑岩','安山岩','草','砂','砂利','レンガ','石レンガ','オークの原木','オークの木材','マツの原木','マツの木材','シラカバの原木','シラカバの木材','ジャングルの原木','ジャングルの木材','アカシアの原木','アカシアの木材','ダークオークの原木','ダークオークの木材',],
            ...
            miscBlock: ['溶岩','水','オークのドア(上)','オークのドア(下)','空気','TNT','岩盤','レッドストーンブロック','グロウストーン','氷ブロック','シーランタン','ジャック・オ・ランタン','フェンス','ネザーレンガのフェンス','鉄格子','本棚','雪ブロック','松明','かまど','木の感圧版','スポンジ','スライムブロック','チェスト','ビーコン','レッドストーンランプ(オフ)','レッドストーンランプ(オン)','レバー','炎',],
