...
(function (ext) {
    ...
    function getrailBlockID(blockName){ }
    ...
    ext.getRailBlockID = getMicratchID;
    ...
    var descriptor = {
        blocks: [
          ...
          ['r', '%m.railBlock', 'getRailBlockID', 'レール'],
          [' ', '周囲をリセット', 'worldReset'],
        ...
        menus: {
            pos: ['x', 'y', 'z'],
            blockPos: ['abs', 'rel'],
            commonBlock: ['石','花崗岩','閃緑岩','安山岩','草','土','丸石','オークの木材','マツの木材','シラカバの木材','ジャングルの木材','アカシアの木材','ダークオークの木材','砂','砂利','オークの原木','マツの原木','シラカバの原木','ジャングルの原木','レンガ','石レンガ','アカシアの原木','ダークオークの原木',],
            ...
            miscBlock: ['空気','岩盤','水','溶岩','スポンジ','TNT','本棚','松明','炎','チェスト','かまど','オークのドア(上)','オークのドア(下)','木の感圧板','氷ブロック','雪ブロック','フェンス','グロウストーン','ジャック・オ・ランタン','鉄格子','ネザーレンガのフェンス','レッドストーンランプ(オフ)','レッドストーンランプ(オン)','ビーコン','レッドストーンブロック','スライムブロック','シーランタン',],
            plantBlock: ['カボチャ','メロンブロック','タンポポ','ポピー','ヒスイラン','アリウム','ヒナソウ','赤色のチューリップ','橙色のチューリップ','白色のチューリップ','桃色のチューリップ','フランスギク','茶色のキノコ','赤色のキノコ',],
            railBlock: ['パワードレール','ディテクターレール','レール','レッドストーントーチ','アクティベーターレール','レッドストーン','レバー',]
        }
    };
    ...
    ScratchExtensions.register('マイクラッチ2.1', descriptor, ext);
