...
(function (ext) {
    ...
    var descriptor = {
        ...
        menus: {
            pos: ['x', 'y', 'z'],
            blockPos: ['abs', 'rel'],
            buildingBlock: ['石','花崗岩','磨かれた花崗岩','閃緑岩','磨かれた閃緑岩','安山岩','磨かれた安山岩','草','土','丸石','オークの木材','マツの木材','シラカバの木材','ジャングルの木材','アカシアの木材','ダークオークの木材','砂','赤い砂','砂利','金鉱石','鉄鉱石','石炭鉱石','オークの原木','マツの原木','シラカバの原木','ジャングルの原木','金ブロック','鉄ブロック','ダイヤブロック','ソウルサンド','ジャック・オ・ランタン','エメラルドブロック'],
